...
- **Harness version**: dev
- **Loop definition SHA-256**: `49b355baae5d8a9066fcee5a2e9f5d0a2291300c14185ee58cca9055cfceec0d`
...
5. `SubagentStop` returns a short integration action. Main runs `runtime task-integrate --assignment-id <id> --root <main-root>` to inspect, merge into the explicitly registered main branch, check, persist completion_ack, and clean up. No develop fallback or automatic Main checkout. On `TeammateIdle`, inspect current progress and re-wake the same teammate when appropriate.
