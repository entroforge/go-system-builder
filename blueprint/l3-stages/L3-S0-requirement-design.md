...
S0 不建立、不重写项目级设计基础。权威定义在 [L4 项目级设计基础](../l4-mechanisms/L4-project-design-foundation.md)，实现与规则见 `docs/rules/design-foundation.md`。
...
| 路径口径 | 首次基线位于 `docs/requirements/REQ-{id}.md`；已绑定基线若修订，旧代不覆盖，新代走通用重做路径 `docs/requirements/versions/{REQ-ID}/g{N+1}/...` |
