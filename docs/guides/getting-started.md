...
`.claude/loop-state.json` and `docs/control/loop-definition.json`.
...
├── docs/guides/getting-started.md                this file
...
├── docs/guides/getting-started.md                     this file (full version)
...
│   └── design/tokens/             Foundation token source + CSS
...
The Manual is generated at release time from `docs/control/loop-definition.json` plus
...
Use the packaged Harness `install --source <release-root> --root <empty-target>` command described in [the installation guide](install.md). The installer performs the following mapping, relocates links, initializes Runtime, and validates the result before publishing it. Do not overlay an existing project.
...
| `docs/guides/getting-started.md` | `docs/guides/getting-started.md` | copy as-is |
...
| `skills/` | `.claude/skills/` | installer copies and relocates links |
| `agents/` | `.claude/agents/` | installer copies and relocates links |
...
│   ├── control/                       protocol, Loop Definition, Hook policy, protected commands
│   ├── requirements/          requirement templates and project REQs
│   ├── design/                        product design, tokens and prototypes
│   ├── architecture/                  architecture, data models, state and dataflow
│   ├── dev/contracts/                 implementation contracts
│   ├── dev/tasks/                     task templates and project tasks
│   ├── reports/release-audits/         release audit template and reports
...
└── .claude/
    ...
    ├── bin/loop-harness               precompiled only (see docs/guides/install.md)
