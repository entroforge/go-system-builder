...
> For execution, read `docs/control/agent-protocol.md` first.
...
| Layer | File | Purpose |
|:---|:---|:---|
| Fast protocol | `docs/control/agent-protocol.md` | decide what to do now |
...
| Contracts | `docs/dev/contracts/` | Builder execution boundary |
| Tasks | `docs/dev/tasks/` | owner, allowed files, steps, acceptance |
| Reports | `docs/reports/` | review, bug, QA, acceptance evidence |
| Release | `docs/reports/release-audits/` | release changes, migration, rollback, and human release gate |
...
The operational stage model is defined in `docs/control/agent-protocol.md`.
