...
// (for assignment_id, agent_id, effective write/output scope and report status). The fields
...
type AssignmentContext struct {
	...
	// WritePaths is the effective union of manifest write_paths and output_paths.
