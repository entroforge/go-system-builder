...
func TestBatchScopeSemanticKeepsCurrentCoverageAndForeignDependenciesSeparate(t *testing.T) {
	...
	write("docs/tasks/TASK-1.md", "> Source REQ refs: REQ-052\n> Status: draft\n")
	write("docs/tasks/TASK-2.md", "> Source REQ refs: REQ-053\n> Status: complete\n> Primary contract: BE-NEW\n")
	write("docs/contracts/CONTRACTS-OLD.md", "> 需求：REQ-052\n\n| BE-OLD §1 |\n")
	write("docs/contracts/CONTRACTS-NEW.md", "> 需求：REQ-053\n\n| BE-NEW §1 |\n")
	write("docs/contracts/BE-OLD.md", "> Status: locked\n")
	write("docs/contracts/BE-NEW.md", "> 需求：REQ-053\n> Status: locked\n")
	write("docs/contracts/BE-ORPHAN.md", "> 需求：REQ-053\n> Status: locked\n")
