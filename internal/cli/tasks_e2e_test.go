...
func TestS4TaskSplitPipelineE2E(t *testing.T) {
	root := t.TempDir()
	for _, rel := range []string{"docs/dev/contracts", "docs/dev/tasks", "docs/requirements", "docs/architecture", ".claude"} {
	...
	write("docs/dev/tasks/TASK-600-02.md", "# TASK-600-02\n\n> Status: complete\n> Version: v1.0.0\n> Primary contract: BE-600\n\n"+
		"## 3. Delivered Clauses\n\n| Contract | Delivered clauses |\n|:--|:--|\n| BE-600 | §2 |\n\n"+
	...
	breaks := []struct {
		...
		{"phantom clause", "docs/dev/tasks/TASK-600-01.md",
			strings.Replace(readFile(t, root, "docs/dev/tasks/TASK-600-01.md"), "| BE-600 | §1 |", "| BE-600 | §1, §9 |", 1),
			"TASK-600-01 declares BE-600 §9"},
		{"uncovered clause cell", "docs/dev/tasks/TASK-600-02.md",
			strings.Replace(readFile(t, root, "docs/dev/tasks/TASK-600-02.md"), "| BE-600 | §2 |", "| BE-600 |  |", 1),
			"BE-600 §2 is not covered"},
		{"missing dependency target", "docs/dev/tasks/TASK-600-01.md",
			strings.Replace(readFile(t, root, "docs/dev/tasks/TASK-600-01.md"), "TASK-600-02 | `ev-01`", "TASK-600-GHOST | `ev-01`", 1),
			"depends on TASK-600-GHOST"},
		{"dependency cycle", "docs/dev/tasks/TASK-600-02.md",
			strings.Replace(readFile(t, root, "docs/dev/tasks/TASK-600-02.md"), "| N/A | — | satisfied |", "| TASK-600-01 | `ev-02` | pending |", 1),
			"dependency cycle: TASK-600-01 -> TASK-600-02 -> TASK-600-01"},
		{"partial batch", "docs/dev/tasks/TASK-600-02.md",
			strings.Replace(readFile(t, root, "docs/dev/tasks/TASK-600-02.md"), "> Status: complete", "> Status: draft", 1),
			`status is "draft"`},
		{"cancelled leaves its clause uncovered", "docs/dev/tasks/TASK-600-02.md",
			strings.Replace(readFile(t, root, "docs/dev/tasks/TASK-600-02.md"), "> Status: complete", "> Status: cancelled", 1),
			"BE-600 §2 is not covered"},
	}
	...
	write("docs/dev/tasks/TASK-600-02.md", strings.Replace(readFile(t, root, "docs/dev/tasks/TASK-600-02.md"), "| BE-600 | §2 |", "| BE-600 | §2, §7 |", 1))
	...
	write("docs/dev/tasks/TASK-600-02.md", strings.Replace(readFile(t, root, "docs/dev/tasks/TASK-600-02.md"), ", §7", "", 1))

	// --- cancelled task: skipped, excluded from coverage aggregation ---
	write("docs/dev/tasks/TASK-600-03.md", "# TASK-600-03\n\n> Status: cancelled\n> Version: v1.0.0\n> Primary contract: BE-600\n\n"+
	...
	for id, entry := range taskEntries {
		...
		diskData, _ := os.ReadFile(filepath.Join(root, "docs", "dev", "tasks", id+".md"))
	...
	write("docs/dev/tasks/TASK-600-01.md", strings.Replace(readFile(t, root, "docs/dev/tasks/TASK-600-01.md"), "v1.0.0", "v1.1.0", 1))
	commitStageFixture(t, root)
	...
	diskData, _ := os.ReadFile(filepath.Join(root, "docs", "dev", "tasks", "TASK-600-01.md"))
...
func TestTasksCheckFlagsNonTaskDependency(t *testing.T) {
	root := t.TempDir()
	for _, rel := range []string{"docs/dev/contracts", "docs/dev/tasks", "docs/requirements"} {
		if err := os.MkdirAll(filepath.Join(root, rel), 0o755); err != nil {
			t.Fatal(err)
		}
	}
	...
	write("docs/dev/contracts/BE-800.md", "# BE-800\n\n> 状态：locked\n> 版本：v1.0.0\n\n### 需求条款映射\n\n| REQ source_ref | Rule / CASE | 本合同条款 | 验收标准 |\n|---|---|---|---|\n| — | — | §1 | — |\n")
	write("docs/dev/contracts/CONTRACTS-800.md", "# CONTRACTS-800\n\n> 状态：locked\n> 版本：v1.0.0\n\n## 需求覆盖矩阵\n\n| REQ source_ref | FE 合同条款 | BE 合同条款 | SYNC 条款 |\n|:--|:--|:--|:--|\n| REQ-800/FR-801 | — | BE-800 §1 | — |\n")
	write("docs/dev/tasks/TASK-800-01.md", "# TASK-800-01\n\n> Status: complete\n> Version: v1.0.0\n> Primary contract: BE-800\n\n"+
		"## 3. Delivered Clauses\n\n| Contract | Delivered clauses |\n|:--|:--|\n| BE-800 | §1 |\n\n"+
...
func TestContractsCheckFlagsClauseNumberDrift(t *testing.T) {
	...
	write("docs/dev/contracts/BE-810.md", "# BE-810\n\n> 状态：locked\n> 版本：v1.0.0\n\n### 需求条款映射\n\n| REQ source_ref | Rule / CASE | 本合同条款 | 验收标准 |\n|---|---|---|---|\n| — | — | §1 | — |\n")
	write("docs/dev/contracts/CONTRACTS-810.md", "# CONTRACTS-810\n\n> 状态：locked\n> 版本：v1.0.0\n\n## 需求覆盖矩阵\n\n| REQ source_ref | FE 合同条款 | BE 合同条款 | SYNC 条款 |\n|:--|:--|:--|:--|\n| REQ-810/FR-811 | — | BE-810 §2 | — |\n")
	var stdout, stderr bytes.Buffer
...
func TestContractsCheckClauseNumberPrecision(t *testing.T) {
	...
	write("docs/dev/contracts/BE-820.md", "# BE-820\n\n> 状态：locked\n> 版本：v1.0.0\n\n### 需求条款映射\n\n| REQ source_ref | Rule / CASE | 本合同条款 | 验收标准 |\n|---|---|---|---|\n| — | — | §10 | — |\n")
	write("docs/dev/contracts/CONTRACTS-820.md", "# CONTRACTS-820\n\n> 状态：locked\n> 版本：v1.0.0\n\n## 需求覆盖矩阵\n\n| REQ source_ref | FE 合同条款 | BE 合同条款 | SYNC 条款 |\n|:--|:--|:--|:--|\n| REQ-820/FR-821 | — | BE-820 §1 | — |\n")
	var stdout, stderr bytes.Buffer
	code := cli.Run([]string{"contracts", "check", "--root", root}, strings.NewReader(""), &stdout, &stderr)
	if code == 0 || !strings.Contains(stderr.String(), "never declares that clause number") {
...
func TestTasksCheckReportsReferenceLoads(t *testing.T) {
	root := t.TempDir()
	for _, rel := range []string{"docs/dev/contracts", "docs/dev/tasks", "docs/requirements", "docs/architecture"} {
		if err := os.MkdirAll(filepath.Join(root, rel), 0o755); err != nil {
			t.Fatal(err)
		}
	}
	...
	write("docs/dev/contracts/BE-830.md", "# BE-830\n\n> 状态：locked\n> 版本：v1.0.0\n\n### 需求条款映射\n\n| REQ source_ref | Rule / CASE | 本合同条款 | 验收标准 |\n|---|---|---|---|\n| — | — | §1 | — |\n")
	write("docs/dev/contracts/CONTRACTS-830.md", "# CONTRACTS-830\n\n> 状态：locked\n> 版本：v1.0.0\n\n## 需求覆盖矩阵\n\n| REQ source_ref | FE 合同条款 | BE 合同条款 | SYNC 条款 |\n|:--|:--|:--|:--|\n| REQ-830/FR-831 | — | BE-830 §1 | — |\n")
	write("docs/dev/tasks/TASK-830-01.md", "# TASK-830-01\n\n> Status: complete\n> Version: v1.0.0\n> Primary contract: BE-830\n\n"+
		"## 2. Document Manifest\n\n| Order | Kind | ID | Path | Clauses |\n|:--|:--|:--|:--|:--|\n| 1 | contract | BE-830 | `docs/dev/contracts/BE-830.md` | §1 |\n| 2 | req | REQ-830 | `docs/requirements/REQ-830.md` | FR |\n\n"+
		"## 3. Delivered Clauses\n\n| Contract | Delivered clauses |\n|:--|:--|\n| BE-830 | §1 |\n\n"+
		"## 4. Scope\n\n| Type | Paths / Commands |\n|:--|:--|\n| read paths | `docs/dev/contracts/BE-830.md` |\n| prospective write paths | `internal/x/a.go`, `internal/x/b.go` |\n\n"+
